...
func initRouter(r *gin.Engine) {
	...
	// extra apis - II
	apiRouter.POST("/relation/action/", utils.RelationAction)
	apiRouter.GET("/relation/follow/list/", utils.FollowList)
	apiRouter.GET("/relation/follower/list/", utils.FollowerList)
}